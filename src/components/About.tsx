      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="glow-card bg-card rounded-xl p-8 mb-12 text-center">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg max-w-4xl mx-auto">
            The Department of Artificial Intelligence and Data Science (AI&DS) at S.A.Engineering College is critical to many modern organizations, especially those in technology, healthcare, finance, and more. This department is responsible for harnessing the power of data and cutting-edge AI techniques to drive informed decision-making, automate processes, and create innovative solutions. We are trying to impart our knowledge through this symposium.</p>
        </div>
