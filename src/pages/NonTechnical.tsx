...
import cinephile from "@/assets/cinephile.png";
            ...
            {nonTechnicalEvents.map((event, index) => (
              ...
              >
                <CardContent className="p-0">
                  {/* Event Image/Icon */}
                  <div className="h-30 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-t-xl flex items-center justify-center overflow-hidden p-0 m-0">
