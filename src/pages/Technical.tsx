...
import hackPoster from "@/assets/hacknhammer.png";
import paperPoster from "@/assets/papershowcase.png";
import bytefest from "@/assets/bytefest.png";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              problem-solving, and innovation skills in Artificial Intelligence and Data Science.
            </p>
          </div>
        </div>
      </div>
            ...
            {technicalEvents.map((event, index) => (
              ...
              >
                <CardContent className="p-0">
                  {/* Event Image/Icon */}
                  <div className="h-70 bg-primary/20 rounded-t-xl flex items-center justify-center overflow-hidden p-0 m-0">
